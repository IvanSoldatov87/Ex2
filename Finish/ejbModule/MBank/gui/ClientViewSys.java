...
public class ClientViewSys extends JInternalFrame{
	...
	public ClientViewSys(ClientFrame parentFrame,String title,Client client)
	{
		...
		sys=MBankST.getInstance().getActionClient().getSysProperty();

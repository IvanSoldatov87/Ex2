...
public class UpdateSys extends JInternalFrame implements ActionListener{
	...
	public UpdateSys(AdminFrame parentFrame, String title)
	{
        ...
        p3.setLayout(new FlowLayout(FlowLayout.CENTER,2,2));
        p4.setLayout(new FlowLayout(FlowLayout.CENTER,2,2));
        p5.setLayout(new FlowLayout(FlowLayout.CENTER,2,2));
        p6.setLayout(new FlowLayout(FlowLayout.CENTER,2,2));
        ...
        lbGD_limit = new JLabel("     Gold credit limit   ");
        txtGD_limit = new JTextField(10);
        lbPD_limit = new JLabel("Platinum credit limit");
        ...
        lbGD_interest = new JLabel("Gold deposit interest");
        txtGD_interest = new JTextField(10);
        lbPD_interest = new JLabel("Platinum deposit interest");
